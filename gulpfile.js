...
// Копирование JavaScript библиотек
function vendorLibs () {
    return src([
        'node_modules/vue/dist/vue.global.prod.js',
        'node_modules/quill/dist/quill.js',
        'node_modules/@vueup/vue-quill/dist/vue-quill.global.prod.js'
    ])
        .pipe(rename(function (path) {
            // Переименовываем vue.global.prod.js в привычное вам vue.js
            if (path.basename === 'vue.global.prod') {
                path.basename = 'vue';
            }
        }))
        .pipe(dest(paths.destLibs));
...
// Копирование CSS стилей редактора Quill
function vendorCss() {
    return src('node_modules/quill/dist/quill.snow.css')
        .pipe(dest(paths.destCss));
}

// Основная задача для разработки (теперь включает копирование скриптов и стилей)
const dev = series(parallel(vendorLibs, vendorCss), buildHtml, buildStyles, cssMin, browserSyncServe, watchFiles);
